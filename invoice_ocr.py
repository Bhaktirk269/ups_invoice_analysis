...
def process_pdf_for_reference(
	...
	for page_number, pil_image in enumerate(images, start=1):
		...
		# Attach page images to each line for potential numeric re-OCR
		for ln in lines:
		...
		for _, idx in matches:
			...
			# Remove personally identifiable context: Sender/Consignee
			# Do not include these in fields or key_values
